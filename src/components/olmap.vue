<template>
  <div>
    <!-- <div @click="clicked" class="topdian">点击</div> -->
    <!-- <input placeholder="加载"> -->
    <div id="map" ref="rootmap"></div>
    <div class="topbar" @click="changeSelect">
    ...
    <div class="small_icon">
      <div class="location_box"  @click="Positioning">
...
<script>
  ...
  export default {
    ...
    methods: {
       clicked(){
            cordova.plugins.MessageIM.coolMethod("hello",function(){
                   // alert("success");
            },function(){
               // alert("fail");
            })
